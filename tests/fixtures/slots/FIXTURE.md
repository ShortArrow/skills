Fixture for the github-paths firing tests (this note is FIXTURE.md so
that README.md can be the project README GitHub would read). A small repository whose
