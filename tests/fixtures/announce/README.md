Fixture for the plain-japanese firing tests.
`announce.md` is a release note in the state a draft arrives in:
...
`ui.md` holds a handful of UI strings with the same defects at sentence scale.
