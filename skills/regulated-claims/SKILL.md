...
| About to… | Instead |
|---|---|
| write that it improves, prevents, relieves or cures something | this is a health claim; what may be said depends on how the product is classified, and the wording is usually prescribed rather than free |
| write "the best", "No.1", "the only", "#1 in Japan" | superlatives and rankings are treated as factual claims; they need a stated basis, a source and a date, or they are dropped |
| pair a before and an after | results shown as typical must be typical, and the qualifier is not a font size |
| quote a customer saying it worked | a testimonial is a claim made through someone else's mouth, and it stays your claim |
| compare against a named competitor | comparative claims carry the heaviest evidential burden and the fastest legal response |
| write "free", "50% off", "usually ¥10,000" | the reference price must be one that was actually charged, for a real period |
| paste text, an image, a chart or a dataset you did not make | quotation has conditions; a citation alone is not one of them |
| name, picture or describe an identifiable person | identifiability, not the name, is the trigger, and consent has a scope |
| write it because a competitor writes it | their exposure is not your defence, and it is often their unresolved risk |
...
|---|---|
| Health, medical, physiological effect | a classification (drug, device, food, cosmetic, ordinary goods) that fixes what may be said at all |
| Superlative, ranking, market position | a survey or source, its date, its scope, and the basis stated where the claim is |
| Comparative against a named rival | evidence for the comparison as made, on a like-for-like basis |
| Price, discount, free, limited time | a real reference price, a real period, real conditions |
| Efficacy backed by testimonial | the same evidence the direct claim would need |
| Safety, environmental, "natural", "chemical-free" | definitions the reader would accept, not the writer's |
