...
せん」が続くと、成り立たないことの列挙になって話が進まない。**言えることは肯定で
書く。**
...
が入り、文の長さが揺れているとき。禁止を守っただけでは足りない。
...
全体で 3 つ数える。単調さは 1 文ずつ見ても出てこない。

- 文末 3 種（ます・です・ません）の合計が 7 割を超えたら単調
- 否定終止が 4 文に 1 つを超えたら、言えることを否定で書いている
- 中央値の 2 倍を超える文と、半分を下回る文。どちらも無ければ平坦
